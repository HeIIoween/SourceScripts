...
if [ ! -f ./drive_c/steamcmd/steamapps/common/Synergy/srcds.exe ];then
	./steamcmd.sh +@sSteamCmdForcePlatformType windows +login $stusername +force_install_dir ./drive_c/steamcmd/steamapps/common/Synergy +app_update 17520 validate +quit
fi
